...
component repos. vLLM, however, sizes the KV cache / attention / decoder from the HF
...
def _merge_with_base(shell: dict) -> dict:
    ...
    # Advertise the MRL ladder so vLLM accepts the `dimensions` pooling parameter.
